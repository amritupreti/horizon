...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "loaders": ["horizon.themes.ThemeTemplateLoader"],
        },
    },
]
...
COMPRESS_PRECOMPILERS = (("text/scss", "horizon.utils.scss_filter.HorizonScssFilter"),)
...
_files.extend(sorted(glob.glob(os.path.join(LOCAL_SETTINGS_DIR_PATH, "*.conf"))))
...
(
    ...
    AVAILABLE_THEMES, DEFAULT_THEME, SELECTABLE_THEMES
)
...
STATICFILES_DIRS += settings_utils.get_xstatic_dirs(XSTATIC_MODULES, HORIZON_CONFIG)
...
#         host="192.168.56.6",
#         user="root",
#         password="6RjZcJT664w8Nj69vTuiRrvNonFn1alOCtxdTPES",
#         port=3306,
#     )
#     cur = conn.cursor()

#     cur.execute("CREATE DATABASE doit if not exists;")
...
#     if ("doit",) in databases:
#         print("doit database already exists")
#     else:
#         print("doit database not exists")
# except Exception as e:
#     print(e)
...
# DATABASES_ROUTERS = [
#     "openstack_dashboard.dashboards.organization_list.routers.DoitDatabaseRouter"
# ]
